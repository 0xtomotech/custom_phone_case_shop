          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto flex flex-col items-center text-center lg:items-start lg:text-left">
              ...
              <p className="mt-8 max-w-prose text-balance text-center text-lg md:text-wrap lg:pr-10 lg:text-left">
                ...
                CaseCobra allows you to protect your phone in style with a
                custom phone case featuring your own image.
              </p>

              <ul className="space-y2 mt-8 flex flex-col items-center text-left font-medium sm:items-start">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col items-center gap-4 sm:gap-6 lg:flex-row">
            <h2 className="text-5cl order-1 mt-2 text-balance text-center font-bold !leading-tight tracking-tight text-gray-900 md:text-6xl">
              What our{" "}
